...
class _OtpVerifyPageState extends State<OtpVerifyPage> {
  final defaultPinTheme = PinTheme(
      ...
      margin: const EdgeInsets.all(PredefinedSize.small));
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: PredefinedSize.large),
            Pinput(
            ...
            const SizedBox(height: PredefinedSize.small),
            Text(
              "RESEND A NEW CODE",
